...
<footer style="background-color: black; color:#ffffff">
      <div class="container">
         ...
         <div class="row">
            <div class="col-lg-2" ><img alt="show.pg" src="/resources/img/book.jpg" style="width: 150px; height: 150px"></div>
            <div class="col-lg-4"><h4></h4><p> 명칭: 주식회사 team5 | 등록번호: 경기 아51514 | 등록연월일: 2020. 6. 11 | 제호: team5
...
발행연월일: 2020 6. 11 | 전화번호: 02 - 6393 - 1111 | E-mail: clswjfgks@naver.com</p></div>
            ...
            <div class="col-lg-2"><h4 style="text-align: center;"><span class="glyphicon glyphicon-ok"></span>&nbsp By TEAM 5 PROJECT</h4></div>
         </div>
      </div>
   </footer>
