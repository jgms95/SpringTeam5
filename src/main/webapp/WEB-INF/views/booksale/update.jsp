	 	...
	 	<div class="row center">
			...
			<form action="/booksale/update" method="post" id="fileform"  enctype="multipart/form-data" style="width:600px ">
				<div class="form-group">
					...
					<input name="ititle" id="ititle" class="form-control" value="${dto.ititle }" required="required">
				</div>
				...
				<div class="form-group">
					...
					<input name="id" id="id" class="form-control" valuer="${dto.id}" readonly="readonly" value="${dto.id }" >
				</div>
				<div class="form-group">
					<label for="writer">저자</label>
					<input name="iwriter" id="iwriter" class="form-control" value="${dto.iwriter}" required="required">
				</div>
				<div class="form-group">
					<label for="writer">출판사</label>
					<input name="publisher" id="iwriter" class="form-control" value="${dto.publisher}" required="required">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input name="price" id="price" class="form-control" value="${dto.price}"  required="required">
				</div>
					<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" name="percent" id="discount" class="form-control" value="${dto.percent}" required="required">
				</div>
