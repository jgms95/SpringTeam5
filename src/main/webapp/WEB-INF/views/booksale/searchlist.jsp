...
<div class="container center">
  ...
  <div class="categories">
		  ...
		  <form action="#" method="post" novalidate="novalidate">
            <div class="row" style="float: right;" >
                <div class="col-lg-12">
                    <div class="row">
                       <div >
                            <select class="form-control search-slt" id="exampleFormControlSelect1" style="width: 120px">
                                <option>장르선택</option>
                                <option>시/에세이</option>
                                <option>경제/경영</option>
                                <option>자기계발</option>
                        ...
                        <div >
                            <input style="width: 200px" type="text" class="form-control search-slt" placeholder="search">
                        </div>
                     
                        <div >
                            <button type="button" class="btn btn-warning wrn-btn">검색</button>
	...
	<div align="center">
 	 ...
 	 <ul class="pagination" style="position: relative; bottom:50px; left: 450px" >
    	<li class="page-item">
