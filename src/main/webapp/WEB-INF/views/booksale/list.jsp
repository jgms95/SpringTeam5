			...
			<ul>
			 ...
			 <c:if test="${login.id=='admin' }">
        	  <button type="button" class="btn btn-info btn-lg" style="float: right;"
               onclick="location.href='/booksale/insert/${login.id}'">상품등록</button></c:if>
               	 <br><br><br>
              <hr>
...
<section id="team" class="pb-5">
    <div class="container">
        <h2 class="section-title h1">베스트 셀러  </h2>
                ...
                <div class="image-flip" >
                   ...
                   <br><br>
                    ...
                    <div class="product-gri">
                     ...
                     <ul class="social">
                        <li><a href="view?ino=${dto.ino }" data-tip="Quick View"><i class="fa fa-search" style="color: white;"></i></a></li>
    ...
    <div class="row" id="sell">
         ...
         <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="../booksale/itemDetail/${dto.ino}">
                    ...
                    <ul class="social">
                        ...
                        <br>
                        <c:if test="${login.id=='admin' }">
                   		<li><a href="/booksale/delete?ino=${dto.ino}&id=${login.id}&ititle=${dto.ititle}"  data-tip="remove"><i class="fas fa-remove" style="color:red;" ></i></a></li>
                 		<li><a href="/booksale/update?ino=${dto.ino}&id=${login.id}" data-tip="update"><i class="fas fa-file" style="color:green;" ></i></a></li>
                   		<br><br>
